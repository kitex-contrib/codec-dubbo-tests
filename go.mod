...
require (
	...
	github.com/kitex-contrib/codec-dubbo-tests/code/kitex_sample v0.0.0
...
require (
	...
	github.com/kitex-contrib/codec-dubbo-tests/code/kitex/extensions v0.0.0 // indirect
...
replace (
	...
	github.com/kitex-contrib/codec-dubbo-tests/code/kitex_sample v0.0.0 => ./code/kitex_sample
)
