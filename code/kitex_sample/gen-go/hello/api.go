...
type GreetResponse struct {
	Resp string `thrift:"resp,1,required" json:"resp"`
}
...
type GreetServiceGreetWithStructArgs struct {
	Req *GreetRequest `thrift:"req,1" json:"req"`
}
...
type GreetServiceGreetWithStructResult struct {
	Success *GreetResponse `thrift:"success,0,optional" json:"success,omitempty"`
}
