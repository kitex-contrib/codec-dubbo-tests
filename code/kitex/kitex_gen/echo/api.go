...
type EchoOptionalStructRequest struct {
	...
	TweetType TweetType `thrift:"tweetType,2,optional" frugal:"2,optional,TweetType" json:"tweetType,omitempty"`
	Req2      *bool     `thrift:"req2,3,optional" frugal:"3,optional,bool" json:"req2,omitempty"`
}
...
var EchoOptionalStructRequest_TweetType_DEFAULT TweetType = TweetType_TWEET

func (p *EchoOptionalStructRequest) GetTweetType() (v TweetType) {
	if !p.IsSetTweetType() {
		return EchoOptionalStructRequest_TweetType_DEFAULT
	}
	return p.TweetType
}

var EchoOptionalStructRequest_Req2_DEFAULT bool

func (p *EchoOptionalStructRequest) GetReq2() (v bool) {
	if !p.IsSetReq2() {
		return EchoOptionalStructRequest_Req2_DEFAULT
	}
	return *p.Req2
}
...
func (p *EchoOptionalStructRequest) SetTweetType(val TweetType) {
	p.TweetType = val
}
func (p *EchoOptionalStructRequest) SetReq2(val *bool) {
	p.Req2 = val
}
...
func (p *EchoOptionalStructRequest) IsSetTweetType() bool {
	return p.TweetType != EchoOptionalStructRequest_TweetType_DEFAULT
}

func (p *EchoOptionalStructRequest) IsSetReq2() bool {
	return p.Req2 != nil
}
...
var EchoOptionalStructResponse_TweetType_DEFAULT TweetType = TweetType_TWEET

func (p *EchoOptionalStructResponse) GetTweetType() (v TweetType) {
	if !p.IsSetTweetType() {
		return EchoOptionalStructResponse_TweetType_DEFAULT
	}
	return p.TweetType
}
...
func (p *EchoOptionalStructResponse) SetTweetType(val TweetType) {
	p.TweetType = val
}
...
func (p *EchoOptionalStructResponse) IsSetTweetType() bool {
	return p.TweetType != EchoOptionalStructResponse_TweetType_DEFAULT
}
