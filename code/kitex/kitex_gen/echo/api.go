...
func NewEchoGenericRequest() *EchoGenericRequest {
	return &EchoGenericRequest{}
}

func (p *EchoGenericRequest) InitDefault() {
	*p = EchoGenericRequest{}
}

func (p *EchoGenericRequest) GetReqField() (v int32) {
	return p.ReqField
}
...
func (p *EchoGenericRequest) String() string {
	if p == nil {
		return "<nil>"
	}
	return fmt.Sprintf("EchoGenericRequest(%+v)", *p)
}
...
func NewEchoGenericResponse() *EchoGenericResponse {
	return &EchoGenericResponse{}
}

func (p *EchoGenericResponse) InitDefault() {
	*p = EchoGenericResponse{}
}

func (p *EchoGenericResponse) GetRespField() (v int32) {
	return p.RespField
}
...
func (p *EchoGenericResponse) String() string {
	if p == nil {
		return "<nil>"
	}
	return fmt.Sprintf("EchoGenericResponse(%+v)", *p)
}

type EchoGenericEmbedded struct {
	InternalStringReq  string `thrift:"internalStringReq,1,required" frugal:"1,required,string" json:"internalStringReq"`
	InternalIntegerReq int32  `thrift:"internalIntegerReq,2,required" frugal:"2,required,i32" json:"internalIntegerReq"`
}

func NewEchoGenericEmbedded() *EchoGenericEmbedded {
	return &EchoGenericEmbedded{}
}

func (p *EchoGenericEmbedded) InitDefault() {
	*p = EchoGenericEmbedded{}
}

func (p *EchoGenericEmbedded) GetInternalStringReq() (v string) {
	return p.InternalStringReq
}

func (p *EchoGenericEmbedded) GetInternalIntegerReq() (v int32) {
	return p.InternalIntegerReq
}
func (p *EchoGenericEmbedded) SetInternalStringReq(val string) {
	p.InternalStringReq = val
}
func (p *EchoGenericEmbedded) SetInternalIntegerReq(val int32) {
	p.InternalIntegerReq = val
}

func (p *EchoGenericEmbedded) String() string {
	if p == nil {
		return "<nil>"
	}
	return fmt.Sprintf("EchoGenericEmbedded(%+v)", *p)
}
