...
type TestServiceEchoJavaEnumArgs struct {
	KitexEnum KitexEnum `thrift:"kitexEnum,1" frugal:"1,default,KitexEnum" json:"kitexEnum"`
}

func NewTestServiceEchoJavaEnumArgs() *TestServiceEchoJavaEnumArgs {
	return &TestServiceEchoJavaEnumArgs{}
}

func (p *TestServiceEchoJavaEnumArgs) InitDefault() {
	*p = TestServiceEchoJavaEnumArgs{}
}

func (p *TestServiceEchoJavaEnumArgs) GetKitexEnum() (v KitexEnum) {
	return p.KitexEnum
}
func (p *TestServiceEchoJavaEnumArgs) SetKitexEnum(val KitexEnum) {
	p.KitexEnum = val
}

func (p *TestServiceEchoJavaEnumArgs) String() string {
	if p == nil {
		return "<nil>"
	}
	return fmt.Sprintf("TestServiceEchoJavaEnumArgs(%+v)", *p)
}
func (p *TestServiceEchoJavaEnumArgs) GetFirstArgument() interface{} {
	return p.KitexEnum
}
...
func NewTestServiceEchoJavaEnumResult() *TestServiceEchoJavaEnumResult {
	return &TestServiceEchoJavaEnumResult{}
}

func (p *TestServiceEchoJavaEnumResult) InitDefault() {
...
func (p *TestServiceEchoJavaEnumResult) String() string {
	if p == nil {
		return "<nil>"
	}
